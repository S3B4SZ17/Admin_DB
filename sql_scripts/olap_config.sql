...
CREATE TABLESPACE glob DATAFILE '$HOME/proyecto_final/tablespaces/dato_glob.dbf' SIZE 3M AUTOEXTEND ON NEXT 12K MAXSIZE 10M;
CREATE TEMPORARY TABLESPACE globtmp TEMPFILE '$HOME/proyecto_final/tablespaces/temp_glob.dbf' SIZE 10M AUTOEXTEND ON NEXT 64K MAXSIZE 20M;
